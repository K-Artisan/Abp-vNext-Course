...
namespace Zo.Store.IdentityServer.IdentityResources
{
    ...
    public class IdentityResourceAppService : IdentityServerAppServiceBase, IIdentityResourceAppService
    {
        ...
        public virtual async Task<IdentityResourceDto> CreateAsync(IdentityResourceCreateOrUpdateDto input)
        {
            ...
            {
                throw new UserFriendlyException(L[IdentityServerErrorConsts.IdentityResourceNameExisted, input.Name]);
            }
        ...
        protected virtual async Task UpdateApiResourceByInputAsync(IdentityResource identityResource, IdentityResourceCreateOrUpdateDto input)
        {
            ...
            if (await IsGrantAsync(IdentityServerPermissions.IdentityResources.ManageClaims))
            {
                // 删除不存在的UserClaim
            ...
            if (await IsGrantAsync(IdentityServerPermissions.IdentityResources.ManageProperties))
            {
                // 删除不存在的Property
